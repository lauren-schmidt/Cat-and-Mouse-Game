...
public class City{
    ...
    public City(Random rand, int numMice, int numCats, int numZombieCats, int numKillerRabbits) {
        this.rand = rand;
        ...
        for (int i=0; i<numKillerRabbits; i++) addKillerRabbit();
        addNewCreatures();
    ...
    //Return a list of the creatures for use in other methods.
    ...
    public void addKillerRabbit(){
        creaturesToAdd.add(new KillerRabbit(rand.nextInt(HEIGHT),rand.nextInt(WIDTH),this,rand));
    }
