...
public class Simulator {
    ...
    public static void main(String[] args) {
        ...
        final String USAGE = "java Simulator numMice numCats numZombieCats numKillerRabbits rounds [randSeed]";
        ...
        int numKillerRabbits = Integer.parseInt(args[3]);
        ...
        City city= new City(rand,numMice,numCats,numZombieCats,numKillerRabbits);
        int count = 0;
